...
import tempfile
from src.data_readers.json_data_reader import *
from src.database.database_connector import *
from src.data_exporters.data_exporter_json import *
from src.data_exporters.data_exporter_xml import *
...
class DataExporterJsonTest(unittest.TestCase):
    ...
    def test_export_students_to_json(self):
        fake_data = [(1, 'John', '1990-01-01', 'M', 'Room1'), (2, 'Jane', '1992-05-15', 'F', 'Room2')]
        mock_cursor = MagicMock()
        mock_cursor.fetchall.return_value = fake_data
        self.mock_connection.cursor.return_value.__enter__.return_value = mock_cursor
